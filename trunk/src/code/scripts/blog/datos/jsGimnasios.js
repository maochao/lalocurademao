var archivoGimnasios = ""
		...
		+ "<fotoMusculacion5>https://googledrive.com/host/0B-eN6ioVpTXPY0V2d0NjSEoyYjQ/Fotos%20Gimnasios/Vivagym%20Las%20Tablas/vLTM5.jpg</fotoMusculacion5>"
		+ "<cardio></cardio>"
		...
		+ "<cardio></cardio>"
		+ "<fotoCardio>https://googledrive.com/host/0B-eN6ioVpTXPY0V2d0NjSEoyYjQ/Fotos%20Gimnasios/Anytimefitness%20Lagasca/aLC.jpg</fotoCardio>"
		+ "<fotoCardio2></fotoCardio2>"
		+ "<fotoCardio3></fotoCardio3>"
		+ "<fotoCardio4></fotoCardio4>"
		+ "<fotoCardio5></fotoCardio5>"
		...
		+ "<foto>https://googledrive.com/host/0B-eN6ioVpTXPY0V2d0NjSEoyYjQ/Logotipos%20Gimnasios/blogGymFit4less.jpg</foto>"
		+ "<tipo>LC</tipo>"
        + "<presentacion>El blog se va a Londres y prueba una de las cadenas de Low Cost de UK, especificamente el de Cricklewood un distrito ubicado al noroeste de Londres, el metro mas cercano es el del Willesden Green y el tren Cricklewood, se encunetra en el segundo piso de un local de 2 plantas, ni bien entrar te encuentras con el area de de cardio, la sala de musculacion tienen pesas de hasta 50 kilos, lo que hecho de menos en este gym es la falta de pecho declinado , hay pocas maquinas de biceps y triceps pero lo solucionas con pesas, falta maquinas para los gemelos pero otra vez lo solucionas con las pesas, en hora punta se suele llenar y como hay 2 gym en la misma avenida este se llena. El gimnasio es ordenado el horario de atencion es de 6:30 - 10 pm de lunes a viernes y los fines de semana es de 9 - 8 pm. En conclusion es un gimnasio lowcost con un buen trato del personal las maquinarias son nuevas, suficientes maquinas de cardio y una sala para tener clases como zumba. Por Julio C. V. M.</presentacion>"
		+ "<fotoPresentacion>https://googledrive.com/host/0B-eN6ioVpTXPY0V2d0NjSEoyYjQ/Logotipos%20Gimnasios/blogGymFit4less.jpg</fotoPresentacion>"
		+ "<instalaciones></instalaciones>"
		...
		+ "<fotoInstalaciones5></fotoInstalaciones5>"
		+ "<staff>8</staff>"
		+ "<masificacionTexto>5</masificacionTexto>"
		+ "<musculacion>5</musculacion>"
		...
		+ "<crucesPolea></crucesPolea>"
		+ "<hackSentadillas></hackSentadillas>"
		+ "<maquinaSoleo>00</maquinaSoleo>"
		+ "<maquinaria></maquinaria>"
		+ "<clases></clases>"
		+ "<precios></precios>"
		+ "<conclusion>Buen gimnasio si piensas en la calidad precio</conclusion>"
		+ "</gimnasio>"
		// ////////////////////////////////////////////////////////////////////////////54
		+ "<gimnasio>"
